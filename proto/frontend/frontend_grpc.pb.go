...
const (
	FrontendService_Put_FullMethodName = "/frontend.FrontendService/Put"
	FrontendService_Get_FullMethodName = "/frontend.FrontendService/Get"
)
...
//
// Frontend service for client-facing API
...
func (c *frontendServiceClient) Put(ctx context.Context, in *PutRequest, opts ...grpc.CallOption) (*PutResponse, error) {
	...
	out := new(PutResponse)
	err := c.cc.Invoke(ctx, FrontendService_Put_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *frontendServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, FrontendService_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
